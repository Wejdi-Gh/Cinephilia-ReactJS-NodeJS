...
apicharge() {
  axios.all([
    axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=4ace3fe68ae5a10120b01abb692f8b4a&language=en-US&page=${this.state.apiincriment}`) ,
    axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=4ace3fe68ae5a10120b01abb692f8b4a&language=en-US&page=${this.state.apiincriment+1}`),
  ])
  ...
  componentDidMount() {
    axios.all([
      axios.get('https://api.themoviedb.org/3/movie/popular?api_key=4ace3fe68ae5a10120b01abb692f8b4a&language=en-US&page=1') ,
      axios.get('https://api.themoviedb.org/3/movie/popular?api_key=4ace3fe68ae5a10120b01abb692f8b4a&language=en-US&page=2'),
    ])
...
export default connect(mapStateToProps) (Apifilm );
